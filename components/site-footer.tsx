      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-lg font-bold">campus.care</h3>
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/diet" className="text-muted-foreground hover:text-foreground transition-colors">
                  Diet Planner
                </Link>
              </li>
              <li>
          ...
          >
            ...
            <p className="text-muted-foreground">Stay updated with the latest features and releases.</p>
